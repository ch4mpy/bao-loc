 ...
 */
@Service
public class BaoLocProblemService implements ProblemService {
	...
	public double computeValue(Solution porposedSolution) {
		return porposedSolution.getX1().doubleValue()
				...
				+ porposedSolution.getX4().doubleValue()
				+ 12.0 * porposedSolution.getX5().doubleValue()
				- porposedSolution.getX6().doubleValue()
				- 11.0
				+ porposedSolution.getX7().doubleValue() * porposedSolution.getX8().doubleValue() / porposedSolution.getX9().doubleValue()
				- 10.0;
	}
