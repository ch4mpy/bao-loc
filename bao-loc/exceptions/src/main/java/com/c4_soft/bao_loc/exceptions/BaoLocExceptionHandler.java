...
public class BaoLocExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers,
		...
		if (ex.getCause() != null && (ex.getCause().getClass().isAssignableFrom(NoSuchElementException.class)
				|| (ex.getCause().getCause() != null
						&& ex.getCause().getCause().getClass().isAssignableFrom(NoSuchElementException.class)))) {
